        ...
        <div className="mt-6 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="px-5 py-7 sm:px-8 sm:py-9">
            ...
            <div className="mt-10 space-y-10">
              ...
              <Section id="data" title="4. 账户、记录与分析数据">
                <p>
                  为提供登录和连续使用体验，浏览器本地存储可能保存登录令牌、账户基本信息及部分使用状态。请勿在不受信任或多人共用设备上长期保留登录状态。
                </p>
                <p>
                  服务可能处理诊断会话、历史记录和用户反馈，并记录必要的运行与分析信息，例如访问页面路径、截断后的 User-Agent、IP 地址，以及根据登录状态记录的用户 ID：登录时可关联账户用户 ID，未登录时不关联账户用户 ID。
                </p>
                <p>
              ...
              <Section id="payment" title="6. 付费能力与数据处理">
                <p>
                  当前服务不具备在线支付和在线退款能力。页面中的券码、会员状态或体验说明不代表已经开通在线收款、自动续费或退款渠道。
                </p>
                <p>
                  用户可以在历史记录功能中删除自己的诊断历史。对于其他数据处理、更正或删除需求，可通过页面反馈入口提交说明；处理范围和结果将受数据实际存储状态、必要安全留存及基础设施能力限制。
                </p>
              </Section>
